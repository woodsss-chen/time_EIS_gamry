...
% samples{3}=EISFitting('1', '160x alumina', dir , 'Li-Li(ALD)-Pt (wcr)', '20180910_Li-Li(ALD)-Pt_gamry_0', '_PEIS.mpt', 0.5,  1);
% samples{4}=EISFitting('1', '160x alumina-compressed', dir , 'Li-Li(ALD_crack)-Pt (wrc)', '20180910_Li-Li(ALD_crack)-Pt_gamry_0_0', '_PEIS.mpt', 0.5,  1);
% 
% save('20180910_FullGroup.mat')
% 
% % xmin=0;
% % xmax=2500;
% 
